 ...
 */
final class Version20241219152648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE realtime.messages_2024_12_20');
        ...
        */
        $this->addSql('ALTER TABLE notification ADD generated_notify_by_id INT NOT NULL');
        $this->addSql('ALTER TABLE notification ADD CONSTRAINT FK_BF5476CA80F6658 FOREIGN KEY (generated_notify_by_id) REFERENCES user_postgres (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('CREATE INDEX IDX_BF5476CA80F6658 ON notification (generated_notify_by_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE realtime.messages_2024_12_20 (inserted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, id UUID DEFAULT \'gen_random_uuid()\' NOT NULL, topic TEXT NOT NULL, extension TEXT NOT NULL, payload JSONB DEFAULT NULL, event TEXT DEFAULT NULL, private BOOLEAN DEFAULT false, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id, inserted_at))');
        ...
        $this->addSql('ALTER TABLE notification DROP CONSTRAINT FK_BF5476CA80F6658');
        $this->addSql('DROP INDEX IDX_BF5476CA80F6658');
        $this->addSql('ALTER TABLE notification DROP generated_notify_by_id');
    }
}
