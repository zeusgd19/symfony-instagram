 ...
 */
final class Version20250109082935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        */
        ...
        $this->addSql('ALTER TABLE notification ADD content_comment VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BF5476CA4B89032C');
        $this->addSql('ALTER TABLE notification DROP post_id');
        $this->addSql('ALTER TABLE notification DROP content_comment');
    }
}
