 ...
 */
final class Version20250109093318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE realtime.messages_2025_01_07');
        $this->addSql('DROP TABLE realtime.messages_2025_01_08');
        $this->addSql('DROP TABLE realtime.messages_2025_01_06');
        $this->addSql('DROP TABLE realtime.schema_migrations');
        $this->addSql('DROP TABLE realtime.subscription');
        $this->addSql('DROP TABLE realtime.messages_2025_01_12');
        $this->addSql('DROP TABLE auth.refresh_tokens');
        $this->addSql('DROP TABLE realtime.messages_2025_01_10');
        $this->addSql('DROP TABLE realtime.messages_2025_01_11');
        $this->addSql('DROP TABLE realtime.messages_2025_01_09');
        ...
        */
        ...
        $this->addSql('ALTER TABLE notification ADD expire_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL');
        $this->addSql('COMMENT ON COLUMN notification.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN notification.expire_date IS \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE realtime.messages_2025_01_12 (inserted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, id UUID DEFAULT \'gen_random_uuid()\' NOT NULL, topic TEXT NOT NULL, extension TEXT NOT NULL, payload JSONB DEFAULT NULL, event TEXT DEFAULT NULL, private BOOLEAN DEFAULT false, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id, inserted_at))');
        $this->addSql('CREATE TABLE auth.refresh_tokens (id BIGSERIAL NOT NULL, instance_id UUID DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, user_id VARCHAR(255) DEFAULT NULL, revoked BOOLEAN DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, parent VARCHAR(255) DEFAULT NULL, session_id UUID DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE realtime.messages_2025_01_10 (inserted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, id UUID DEFAULT \'gen_random_uuid()\' NOT NULL, topic TEXT NOT NULL, extension TEXT NOT NULL, payload JSONB DEFAULT NULL, event TEXT DEFAULT NULL, private BOOLEAN DEFAULT false, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id, inserted_at))');
        $this->addSql('CREATE TABLE realtime.messages_2025_01_11 (inserted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, id UUID DEFAULT \'gen_random_uuid()\' NOT NULL, topic TEXT NOT NULL, extension TEXT NOT NULL, payload JSONB DEFAULT NULL, event TEXT DEFAULT NULL, private BOOLEAN DEFAULT false, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id, inserted_at))');
        $this->addSql('CREATE TABLE realtime.messages_2025_01_09 (inserted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, id UUID DEFAULT \'gen_random_uuid()\' NOT NULL, topic TEXT NOT NULL, extension TEXT NOT NULL, payload JSONB DEFAULT NULL, event TEXT DEFAULT NULL, private BOOLEAN DEFAULT false, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id, inserted_at))');
        ...
        $this->addSql('ALTER TABLE notification DROP expire_date');
    }
}
